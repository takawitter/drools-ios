...
import org.drools.core.common.InternalTypesClassLoader;
import org.drools.core.common.ProjectClassLoader;

import jp.takawitter.drools.ios.compile.ClassWriter;

public class DexInternalTypesClassLoader extends MultiDexClassLoader implements InternalTypesClassLoader {
    ...
    public Class<?> defineClass(String name, byte[] bytecode) {
        ...
        if (lastDot > 0) {
            ClassWriter.write(name, bytecode);
